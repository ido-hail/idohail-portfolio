...
- Worked directly with engineering, product, business stakeholders, executives, vendors and B2B and B2C clients on technical delivery.

### Impact

- Reduced production data incidents by more than 30% through the automated SQL and Python data-quality framework.
- Changed issue detection from next-day discovery to real-time visibility by introducing automated monitoring and alerting.
